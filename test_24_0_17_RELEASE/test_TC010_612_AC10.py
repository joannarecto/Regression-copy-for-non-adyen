...
class Test_TC001(baseclass):
    ...
    def test_TC010(self):
        ...
        # AC10 Physical product - diff bill address - to same
        ...
        # compare fo bill
        assert e.get_billing_firstname_value() == ""
        assert e.get_billing_lastname_value() == ""
        assert e.get_billing_country_value() == ""
        assert e.get_billing_addressline1_value() == ""
        assert e.get_billing_addressline2_value() == ""
        assert e.get_billing_city_value() == ""
        assert e.get_billing_state_value() == ""
        assert e.get_billing_postcode_value() == ""
        ...
        print(order_total)
        print(g.get_gbp_ordertotal())

        print("\nTEST010 " + g.get_orderid())
