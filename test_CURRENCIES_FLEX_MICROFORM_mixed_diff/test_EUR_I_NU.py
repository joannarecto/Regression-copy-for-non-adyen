...
class Test_EUR_I(baseclass):
    ...
    def test_EUR_I(self):
        ...
        eur_i_mixed_price = a.get_eur_i_mixed_price()

        eur_i_ordertotal = eur_i_subtotal = eur_i_mixed_price

        a.click_cart()

        assert eur_i_mixed_price == b.get_eur_i_mixed_price()
        ...
        assert eur_i_mixed_price == e.get_eur_i_mixed_price()
        ...
        assert eur_i_mixed_price == g.get_eur_i_mixed_price()
