...
class Test_CAD(baseclass):
    ...
    def test_CAD(self):
        ...
        cad_PP1_price = a.get_cad_PP1_price()

        cad_ordertotal = cad_subtotal = cad_PP1_price

        a.click_cart()

        assert cad_PP1_price == b.get_cad_PP1_price()
        ...
        assert cad_PP1_price == g.get_cad_PP1_price()
