...
class Test_USD(baseclass):
    ...
    def test_USD(self):
        ...
        usd_PP1_price = a.get_usd_PP1_price()

        usd_ordertotal = usd_subtotal = usd_PP1_price

        a.click_cart()

        assert usd_PP1_price == b.get_usd_PP1_price()
        ...
        assert usd_PP1_price == e.get_usd_PP1_price()
        ...
        assert usd_PP1_price == g.get_usd_PP1_price()
